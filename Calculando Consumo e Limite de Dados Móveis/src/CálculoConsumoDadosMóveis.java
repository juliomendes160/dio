...
public class CálculoConsumoDadosMóveis {
    ...
    public static int calcularMediaSemanal(int totalConsumo, int numeroDeSemanas) {
        return numeroDeSemanas > 0 ? totalConsumo / numeroDeSemanas : 0; // Evita divisão por zero
    }
    ...
    public static int identificarSemanaDeMaiorConsumo(String[] consumoSemanal) {
        ...
        // Identificar a semana de maior consumo
        for (int i = 0; i < consumoSemanal.length; i++) {
            ...
            if (consumo > maiorConsumo) {
                ...
                semanaDeMaiorConsumo = i + 1; // +1 para considerar a semana começando em 1
            }
        }
