...
class ComboServicos {
    ...
    public double calcularValorTotal() {
        ...
        double desconto = 0;
        // Aplique o desconto correspondente à quantidade de serviços contratados
        switch (servicosContratados) {
            ...
            case 3:
                ...
                break;
            default:
                desconto = 0; // Nenhum desconto se não houver serviços contratados
        }
        ...
        // Aplique desconto adicional se todos os três serviços foram contratados
...
public class CálculoDescontoProgressivoCombo {
