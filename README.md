# Dominando Interfaces e Lambda em Java | Curso | Básico | 2 hrs

![alt text](image.png)

Dominando Interfaces e Lambda em Java:

1.1 Interfaces 29:11

2.1 Interfaces Funcionais 19:57

3.1 Entendendo algumas keywords usadas 31:15

Exercícios: Interfaces e Lambda em Java:

4.2 Exercícios 28:40
...
https://download-cdn.jetbrains.com/idea/ideaIC-2023.3.3.win.zip

# Java

https://download.oracle.com/java/21/archive/jdk-21.0.2_windows-x64_bin.zip

https://download.oracle.com/java/21/archive/jdk-21.0.6_windows-x64_bin.zip

# Materiais de Apoio

Os materiais complementares e de apoio que oferecemos têm como objetivo fornecer informações para facilitar e enriquecer a sua jornada de aprendizado no curso "Dominando Interfaces e Lambda em Java". Aqui você encontrará links úteis, como slides, repositórios e páginas oficiais, além de dicas sobre como se destacar na DIO e no mercado de trabalho 😉
