...
### 3.3 Desenvolvimento Avançado em PHP | Adriano Maciel

![alt text](<Formação PHP Experience/3 Boas Práticas PHP e Desenvolvimento de APIs com Laravel/3.3-Desenvolvimento-Avançado-em-PHP/image.png>)

1 Trabalhando com Composer e PHPUnit
1.1 Gerenciando pacotes com Composer
1.2 Criando código utilizando Composer
1.3 Gerando o diretório vendor com composer
1.4 Testes unitários com PHPUnit
1.5 Aprenda na prática como testar códigos com PHPUnit
1.6 Gerando relatório code coverag

2 Como padronizar seu código utilizando frameworks
2.1 Introdução ao PSRs
2.2 Utilizando o PHP CodeSniffer
2.3 Frameworks e Micro Frameworks

3 Laravel: Instalação e estrutura básica
3.1 Instalação e configuração do ambiente em Laravel
3.2 Estrutura básica dos arquivos de Laravel

4 Laravel: APIs - Rotas - Model
4.1 Conceito e estrutura de Rotas
4.2 Conceito e estrutura de APIs e Model

5 Laravel: Blade Template
5.1 Comandos básicos do Blade Template
5.2 Validação de cadastros
5.3 Introdução a Carbon
5.4 Testando a API
5.5 Implementando a API

6 Instalando e personalizando o Symfony
6.1 Introdução ao framework
6.2 Instalando e configurando o Symfony
6.3 Aprenda como personalizar o framework
6.4 Rotas e API
6.5 Veja como trabalhar com rotas YAML
6.6 Implementando rotas e controllers

7 Desenvolvendo route model
7.1 Introdução aos templates
7.2 Conexão ao banco de dados com models
7.3 Manipulando banco de dados
7.4 Finalizando a API
